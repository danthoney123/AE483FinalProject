...
if __name__ == '__main__':
    ...
    drone_client.move(0.0, 0.0, 0.5, 0.0, 4.0)  # take off and hover at a height of 0.5 meters
    drone_client.move(0.2, 0.0, 0.5, 0.0, 4.0)  # move 0.2 meters forward
    drone_client.move(0.2, 0.2, 0.5, 0.0, 4.0)  # move 0.2 meters left
    drone_client.move(0.0, 0.2, 0.5, 0.0, 4.0)  # move 0.2 meters back
    drone_client.move(0.0, 0.2, 0.5, 0.0, 4.0)  # move 0.2 meters back
    drone_client.move(0.0, 0.0, 0.5, 0.0, 4.0)  # move 0.2 meters right
    ...
    with open('carpet.json', 'w') as outfile:
