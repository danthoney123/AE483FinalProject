...
uri_01 = 'radio://0/16/2M/E7E7E7E7E7' # <-- FIXME
uri_02 = 'radio://0/32/2M/E7E7E7E7E7'
...
if __name__ == '__main__':
    ...
    drone_client_01 = CrazyflieClient(
        uri_01,
        use_controller=True,
        use_observer=False,
        use_safety=False,
    ...
    drone_client_02 = CrazyflieClient(
        uri_02,
        use_controller=True,
        use_observer=False,
        use_safety=False,
    ...
    drone_clients = [drone_client_01, drone_client_02]

    # Wait until the client is fully connected to the drone
    while not drone_client_01.is_fully_connected or drone_client_02.is_fully_connected:
        time.sleep(0.1)
    
    # Create and start the client that will connect to the motion capture system
    if use_mocap:
        pose_queue_01 = SimpleQueue()
        pose_queue_02 = SimpleQueue()
        Thread(target=send_poses, args=(drone_client_01, pose_queue_01)).start()
        Thread(target=send_poses, args=(drone_client_02, pose_queue_02)).start()
        mocap_client_01 = QualisysClient(ip_address, marker_deck_name, pose_queue_01)
        mocap_client_02 = QualisysClient(ip_address, marker_deck_name, pose_queue_02)
    ...
    ## Flight code here!
    def GetFlightCommands(drone_client):
        return [
            # short hop
    ...
    # Run flight commands
    for drone_client in drone_clients:
        for command in GetFlightCommands(drone_client):
    ...
    data_01 = {}
    data_01['drone'] = drone_client_01.data
    data_01['mocap'] = {} #mocap_client.data if use_mocap else {}
    data_02 = {}
    data_02['drone'] = drone_client_02.data
    data_02['mocap'] = {} #mocap_client.data if use_mocap else {}
